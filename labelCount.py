...
# maxCount and avgCount are unset
labelStruct11 = LabelStruct(fileName="../DataSets/RelatedSearch/related_search_X2dense_L5K.pkl", totalCount=5000, maxCount=0, avgCount=0, resFile='res_relatedSearch_X2_L5K');
